...
import image from '../assets/tour/walk.jpg';
          ...
          <div className="grid lg:grid-cols-3 gap-6 xl:gap-x-12">
            <div className="mb-6 lg:mb-0">
              <div>
                ...
                >
                  <img src={image} className="w-full" alt="Louvre" />
                  <a href="#!">
                    <div
                ...
                <h5 className="text-lg font-bold mb-3">Trip to California</h5>
